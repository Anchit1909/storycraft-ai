          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-24">
            <div className="text-left">
              <div className="relative flex items-center">
                <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl Handlee">
                  {story.title}
                </h1>
                <img
                  height={256}
                  width={256}
                  src={story.thumbnail}
                  className="opacity-80 mx-auto rounded-lg shadow-sm shadow-gray-300"
                />
              </div>
              <div>
                <audio
                  controls
                  className="mx-auto my-7 w-full"
                  src={story.audioURL}
                >
              ...
              {story.description.split("\n\n").map((item: any) => (
                <p key={item} className="mt-6 text-lg leading-8 text-gray-300">
                  {item}
                </p>
              ))}
            </div>
